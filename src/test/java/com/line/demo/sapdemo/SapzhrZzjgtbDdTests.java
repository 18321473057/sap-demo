 ...
 * @Author: yangcs
 * @Date: 2020/8/31 9:06
 * @Description: 组织架构同步接口-全量
 */
@SpringBootTest
class SapzhrZzjgtbDdTests {
    ...
    void ZHR_RYXXTB_ET_O() {
        ...
        try {
            //获取表单
            tableDto = jcoClient.getJocTable("ZHR_ZZJGTB_DD", "ET_O");
...
//                insertPo.setzBz(jCoTable.getString("Z_BZ"));
    ...
    void ZHR_RYXXTB_ET_S() {
        ...
        try {
            //获取表单
            tableDto = jcoClient.getJocTable("ZHR_ZZJGTB_DD", "ET_S");
...
//                insertPo.setzBz(jCoTable.getString("Z_BZ"));
    ...
    void ZHR_RYXXTB_ET_PS() {
        ...
        try {
            //获取表单
            tableDto = jcoClient.getJocTable("ZHR_ZZJGTB_DD", "ET_PS");
